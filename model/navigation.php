         ...
         <nav class="navbar navbar-inverse navbar-fixed-top" id="navbar-inverse">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="color: white;">
                    <li><a class="<?php if($currentPage =='dashboard.php'){echo 'active';}?>" href="dashboard.php">Sales</a></li>
                    ...
                    <li><a class="<?php if($currentPage =='report.php'){echo 'active';}?>" href="report.php">Sales report</a></li>
                    <?php
